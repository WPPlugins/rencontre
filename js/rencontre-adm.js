...
function f_edit(f,a2,a3,a4,a5,g){
	...
	// a5 : langues separees par & : fr&en - '', type (1 a 5)
	// a6 on submit (type)
	...
	jQuery.post('admin-ajax.php',{'action':'profilA','a1':a1,'a2':a2,'a3':a3,'a4':a4,'a5':a5,'a6':a6,'g':g},function(r){
		if(a3=='c_categ'||r.substr(0,6)=='reload')location.reload(true);
			...
			if(a1=='edit'&&a3=='c_label'){
				...
				a=a.split('&');
				jQuery('#rencValeur'+a2).children('.valeur').children('span').each(function(){
...
function rencStat(){
	...
	}else jQuery('#rencStat').slideUp(800,function(){jQuery('#rencStat1').empty();jQuery('#rencStat2').empty();});
}
